 ...
 *
 */
@Component("customerRegExBean")
public class CustomerRegularExpression {
	...
	@Value("#{emailBean.emailAddress matches customerRegExBean.emailRegEx}")
	...
	public String toString() {
		return "CustomerRegularExpression [validDigit=" + validDigit + ", msg=" + msg
